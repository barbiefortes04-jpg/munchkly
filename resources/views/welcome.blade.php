...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col items-center justify-center px-4 relative">
    ...
    <div class="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div class="mb-12 animate-fade-in-up">
            <div class="flex items-center justify-center mb-8">
                <div class="bg-white rounded-full p-3 shadow-lg mr-4">
                    <img src="{{ asset('images/logo.jpg') }}" alt="Munchkly Logo" class="w-16 h-16 rounded-full object-cover">
                </div>
                <div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in-up animation-delay-600">
            <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-colors duration-200">
                Get Started
            </a>
            <a href="{{ route('login') }}" class="bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-8 rounded-lg border border-gray-300 transition-colors duration-200">
                Sign In
            </a>
        </div>
