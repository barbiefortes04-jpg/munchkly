            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="flex items-center">
                            <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center mr-2 overflow-hidden">
                                <img src="{{ asset('images/logo.jpg') }}" alt="Munchkly Logo" class="w-6 h-6 rounded-full object-cover">
                            </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        @if($isAuth && $authUser)
                            <a href="{{ route('profile.show', $authUser->id) }}" class="px-3 py-2 rounded-md text-sm font-medium theme-transition" style="color: var(--text-secondary);" onmouseover="this.style.color='var(--text-primary)'" onmouseout="this.style.color='var(--text-secondary)'">
                            ...
                            <span class="text-sm" style="color: var(--text-secondary);">Hi, {{ $authUser->name }}!</span>
                        @else
                            <a href="{{ route('login') }}" class="px-3 py-2 rounded-md text-sm font-medium theme-transition" style="color: var(--text-secondary);" onmouseover="this.style.color='var(--text-primary)'" onmouseout="this.style.color='var(--text-secondary)'">
